...
const Aboutus = () => {
  return (
    <div id="about" className=" lg:py-36 md:py-28 sm:py-20 py-10  relative overflow-x-clip">
      <img src={triangle} alt="triangle" className=" absolute top-[-5%] left-[3%] z-[1] lg:block hidden animate-bounce-slow" />
      ...
      <div className="container max-w-[1140px] 2xl:max-w-[1320px] px-3 mx-auto">
        <div className="flex items-center flex-row justify-between -mx-3 flex-wrap">
